...
def server(input, output, session):
    ...
    _pg_all, _pg_colors = A.load_and_validate_priority_groups(PRIORITY_GROUPS_PATH)
    ...
    def _load_region(chrom, g_s, g_e, db, *,
        ...
        extra_types = A.build_extra_types(feats, tx_types, priority_groups(), excluded_patterns())
    ...
    def _apply_uploads():
        ...
        if pg_info:
            ...
            _pg_all = A.load_and_validate_priority_groups(dest)
